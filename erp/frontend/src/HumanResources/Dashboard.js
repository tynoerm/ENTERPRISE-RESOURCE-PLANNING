                    ...
                    <div class="col mb-3 shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card shadow p-3 mb-5 bg-body rounded">
                            ...
                            <div class="card-body ">
                                ...
                                <Link to="/Payroll" type="button"     class="btn btn-primary"> Next </Link>
                        ...
                        <div class="card shadow p-3 mb-5 bg-body rounded">
                            ...
                            <div class="card-body ">
                                ...
                                <p class="card-text">Its main contents include job requisition creation, applicant tracking, job posting and candidate sourcing, screening and shortlisting, .
                                    .</p>
                                    <Link to="/Recruitment" type="button"     class="btn btn-primary"> Next </Link>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4 shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card shadow p-3 mb-5 bg-body rounded">
                            ...
                            <div class="card-body">
                                ...
                                <Link to="/PerfomanceManagement" type="button"     class="btn btn-primary">  Next </Link>
                            </div>
                        </div>
                    </div>
