...
const Payroll = () => {
  ...
  const [deductions_medicalcontribution, setDeductions_medicalcontribution] =
    useState("");
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(event) => {
                    seteEmployee_status(event.target.value);
                  }}
                />
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(event) => {
                    setBase_salary(event.target.value);
                  }}
                />
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(event) => {
                    setDeductions_medicalcontribution(event.target.value);
                  }}
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(event) => {
                    setBanking_details(event.target.value);
                  }}
                />
              </div>
