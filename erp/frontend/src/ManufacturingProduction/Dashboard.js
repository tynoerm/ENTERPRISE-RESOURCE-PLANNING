                    ...
                    <div class="col mb-3 shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card shadow p-3 mb-5 bg-body rounded">
                            ...
                            <div class="card-body ">
                                ...
                                <Link to="/BillofMaterials" type="button"     class="btn btn-primary"> Next </Link>
                    ...
                    <div class="col mb-4 shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card shadow p-3 mb-5 bg-body rounded">
                            ...
                            <div class="card-body ">
                                ...
                                <Link to="/ProductionOrders" type="button"     class="btn btn-primary"> Next </Link>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4 shadow-sm p-3 mb-5 bg-body rounded">
                        <div class="card shadow p-3 mb-5 bg-body rounded">
                            ...
                            <div class="card-body">
                                ...
                                <Link to="/QualityControl" type="button"     class="btn btn-primary">  Next </Link>
                            </div>
                        </div>
                    </div>
